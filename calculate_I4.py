# https://github.com/DCDmllm/Cheetah/blob/main/DEMON%20Benchmark/scripts/evaluate.py
# DEMON Benchmark (I4 benchmark) from "Fine-tuning Multimodal LLMs to Follow Zero-shot Demonstrative Instructions"
import re
